...
$(document).ready(function () {
    ...
    $('.add-more').on('click touchstart', function (e) {
        ...
        var newIn = '<tr class="appliRow' + newAcademicsNo + '" id="field1"> <td class="col-2" style="text-align: center; padding: 0;">' +
            '<input type="text" name="course' + newAcademicsNo + '" id="course' + newAcademicsNo + '" style="margin: 0; background-color: transparent; border:none; background-color: transparent; border: none;" placeholder="Enter Course" ></td>' +
            ...
            '<option value="Class 10th">Class 10th</option>' +
            '</select></td>' +
            '<td class="col-2" style="text-align: center; padding: 0;"><input type="text" name="course' + newAcademicsNo + '-name" id="course' + newAcademicsNo + '-name" style="margin: 0; background-color: transparent; border:none;" placeholder="Name of Board/College/University"  ></td>' + '<td class="col-2" style="text-align: center; padding: 0;">' +
            '<select name="course' + newAcademicsNo + '-percentage" id="course' + newAcademicsNo + '-percentage" style="margin: 0; background-color: transparent; border:none;" placeholder="Select Mode" onchange="modeFirst(event)" ><option value="" selected disabled>Select Mode</option><option value="Percentage"> Percentage </option><option value="CGPA out of 10"> CGPA out of 10 </option><option value="GPA out of 5"> GPA out of 5 </option></select></td><td class="col-1" style="text-align: center; padding: 0;">' +
            '<input readonly type="number" name="course' + newAcademicsNo + '-obtained" id="course' + newAcademicsNo + '-obtained" step=".01" onchange="marksValidation(event)" value="" style="margin: 0; background-color: transparent; border:none;" placeholder="Obtained" ></td>' +
            '<td class="col-2" style="text-align: center; padding: 0;"><input type="text" name="course' + newAcademicsNo + '-subject" id="course' + newAcademicsNo + '-subject" value="" style="margin: 0; background-color: transparent; border:none;" placeholder="Subject(s)" ></td><td class="col-2" style="text-align: center; padding: 0; font-size: xx-small;">' +
...
$(document).ready(function () {
    ...
    $('.add-more2').on('click touchstart', function (e) {
        ...
        var newIn2 = '<tr id="field1"><td class="col-2" style="text-align: center; padding: 0;vertical-align: middle;">' +
            ...
            '<td class="col-3" style="display:flex;place-content:space-between;height:6em;">' + '<span style="overflow:hidden;align-self:center"><input  style="font-size:x-small;" type="file" id="org' + newAcademicsNo + '-file" name="org' + newAcademicsNo + '-file" accept=".pdf"></span>' +
            '<span style="display:inline;align-self:center"><button type="button" onclick="removeRow(event)" class="btn remBtn" style="padding: 0;height: 0 !important;min-width:auto!important;margin:0!important;width: 2rem !important;font-size: 0.8em;color: #c514148a !important;">X</button></span>' +
            '</td></tr>';
...
$(document).ready(function () {
    ...
    $('.add-more2B').on('click touchstart', function (e) {
        ...
        var newIn2 = '<tr id="field1">' +
            ...
            '<td class="col-3" style="display:flex;place-content:space-between;height:4.4em;">' + '<span style="overflow:hidden;align-self:center"><input style="font-size:x-small;" type="file"  accept=".pdf" id="exp' + newAcademicsNo + '-file" name="exper' + newAcademicsNo + '-file"></span>' +
...
$(document).ready(function () {
    ...
    $('.add-more3').on('click touchstart', function (e) {
        ...
        var newIn3 = '<tr id="field1">' +
            ...
            '<td class="col-3" style="display:flex;place-content:space-between;height:5em;">' + '<span style="overflow:hidden;align-self:center"><input  style="font-size:x-small;" type="file" name="books' + newAcademicsNo + '-file" id="books' + newAcademicsNo + '-file" accept=".pdf" ></span>' +
            '<span style="display:inline;align-self:center"><button type="button"  onclick="removeRow(event)" class="btn remBtn" style="padding: 0;height: 0 !important;min-width:auto!important;margin:0!important;width: 2rem !important;font-size: 0.8em;color: #c514148a !important;">X</button></span>' +
            '</td></tr>';
...
$(document).ready(function () {
    ...
    $('.add-more4').on('click touchstart', function (e) {
        ...
        var newIn4 = '<tr id="field1"><td class="col-1" style="text-align: center; padding: 0;vertical-align: middle;"><input  type="text" name="chapters' + newAcademicsNo + '-book_title" id="chapters' + newAcademicsNo + '-book_title" style="margin: 0; background-color: transparent; border:none; background-color: transparent; border: none;" placeholder="Title of the Chapter(s) "></td>' +
            ...
            '<td class="col-3" style="display:flex;place-content:space-between;height:5em">' + '<span style="overflow:hidden;align-self:center"><input  style="font-size:x-small;" type="file" name="chapters' + newAcademicsNo + '-file" id="chapters' + newAcademicsNo + '-file" accept=".pdf" ></span>' +
...
$(document).ready(function () {
    ...
    $('.add-more5').on('click touchstart', function (e) {
        ...
        var newIn6 = '<tr id="field1"><td class="col-1" style="text-align: center; padding: 0;vertical-align: middle;"><input  type="text" name="news_articles' + newAcademicsNo + '-article_title" id="news_articles' + newAcademicsNo + '-article_title" style="margin: 0; background-color: transparent; border:none; background-color: transparent; border: none;" placeholder="Title of research"></td>' +
            ...
            '<td class="col-2" style="text-align: center; padding: 0; font-size: xx-small;vertical-align: middle;"><input  type="number" step=".01" name="news_articles' + newAcademicsNo + '-page" id="news_articles' + newAcademicsNo + '-page" style="border: 0; background: transparent;" placeholder="Volume no. & Page nos."></td>' +
            ...
            '<td class="col-3" style="display:flex;place-content:space-between;padding:0.48em;">' + '<span style="overflow:hidden;align-self:center"><input  style="font-size:x-small;" type="file" name="news_articles' + newAcademicsNo + '-file" id="news_articles' + newAcademicsNo + '-file" accept=".pdf" ></span>' +
            '<span style="display:inline;align-self:center"><button type="button" onclick="removeRow(event)" class="btn remBtn" style="padding: 0;height: 0 !important;min-width:auto!important;margin:0!important;width: 2rem !important;font-size: 0.8em;color: #c514148a !important;">X</button></span>' +
            '</td></tr>';
...
$(document).ready(function () {
    ...
    $('.add-more6').on('click touchstart', function (e) {
        ...
        var newIn7 = '<tr id="field1"><td class="col-2" style="text-align: center; padding: 0;vertical-align: middle;"><input type="text" name="semi_articles' + newAcademicsNo + '-article_title" id="semi_articles' + newAcademicsNo + '-article_title" value="" style="margin: 0; background-color: transparent; border:none;" placeholder="Title of research article/paper(s)"></td>' +
            ...
            '<td class="col-3" style="display:flex;place-content:space-between;height:6em;padding:0;">' + '<span style="overflow:hidden;align-self:center"><input style="font-size:x-small;" type="file" name="semi_articles' + newAcademicsNo + '-file" id="semi_articles' + newAcademicsNo + '-file" accept=".pdf" ></span>' +
            '<span style="display:inline;align-self:center"><button type="button" onclick="removeRow(event)" class="btn remBtn" style="padding: 0;height: 0 !important;min-width:auto!important;margin:0!important;width: 2rem !important;font-size: 0.8em;color: #c514148a !important;">X</button></span>' +
            '</td></tr>';
