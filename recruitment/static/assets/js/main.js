...
$(document).ready(function() {
    ...
    for(var ii=0;ii<4;ii+=1){
        var newIn = '<tr class="appliRows' + newAcademicsNo + '" id="field1"> <td class="col-1" style="text-align: center; padding: 0;">' +
            ...
            '<select onchange="reqField(event)" name="course' + newAcademicsNo + '-percentage" id="course' + newAcademicsNo + '-percentage" style="margin: 0; background-color: transparent; border:none; inline-size:auto;" placeholder="Select Mode" required><option value="" selected disabled>Select Mode</option><option value="Percentage"> Percentage </option><option value="CGPA out of 10"> CGPA out of 10 </option><option value="GPA out of 5"> GPA out of 5 </option></select></td><td class="col-1" style="text-align: center; padding: 0;">' +
            '<input onchange="reqField(event)" type="number" name="course' + newAcademicsNo + '-obtained" id="course' + newAcademicsNo + '-obtained" value="" onchange="marksValidation(event)" style="margin: 0; background-color: transparent; border:none;" placeholder="Obtained" required></td>'+
...
$(document).ready(function() {
    ...
    $('.add-more').on('click touchstart', function(e) {
        ...
        var newIn = '<tr class="appliRow' + newAcademicsNo + '" id="field1"> <td class="col-2" style="text-align: center; padding: 0;">' +
            ...
            '<input type="text" name="course' + newAcademicsNo + '-obtained" id="course' + newAcademicsNo + '-obtained" onchange="marksValidation(event)" value="" style="margin: 0; background-color: transparent; border:none;" placeholder="Obtained" required></td>' +
