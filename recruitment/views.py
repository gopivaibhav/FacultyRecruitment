...
# For development -> Opens ViewApplication in a webpage rather than in a pdf

# def checkPdf(request,application_number):
#     data = {
#         'applicant_data': {
...
#         },
#         'general_data': {
#             'full_name': (General.objects.filter(applicant=application_number)[0].full_name).strip(),
...
#             'telephone_perm': (General.objects.filter(applicant=application_number)[0].telephone_perm).strip(),
...
#             'telephone_mail': (General.objects.filter(applicant=application_number)[0].telephone_mail).strip(),
...
#     }
#     return render(request, 'recruitment/pdfTest.html', data)
